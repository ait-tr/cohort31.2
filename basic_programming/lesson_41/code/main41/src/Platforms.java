...
public class Platforms {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Minimum platforms required: " + findMinPlatformsNumber(arr,dep));
    }
    /*
    Написать метод, находящий минимальное количество платформ требуемых
    на ж/д станции чтобы принять количество поездов по расписанию
