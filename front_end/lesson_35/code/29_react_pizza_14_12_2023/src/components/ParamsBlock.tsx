      ...
      <ul className='card__block-list'>
        ...
        types.map((typeId, index) => (
          <li className='card__block-item' key={index}>
            <button
              className={`card__block-button button ${typeIndex === typeId ? 'card__block-button_active' : ''}`}
              type='button'
      ...
      <ul className='card__block-list'>
        ...
        sizes.map((size, index) => (
          <li className='card__block-item'>
            <button
              className={`card__block-button button ${sizeIndex === size ? 'card__block-button_active' : ''}`}
              type='button'
